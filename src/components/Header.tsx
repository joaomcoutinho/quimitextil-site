        ...
        <nav className="relative z-10 max-w-7xl mx-auto px-6 flex items-center justify-between h-[68px]">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1.5 bg-brand-orange hover:bg-brand-orangehover text-white font-label font-bold text-[0.65rem] uppercase tracking-wide rounded-full pl-3 pr-4 py-2 transition-colors duration-150"
            >
